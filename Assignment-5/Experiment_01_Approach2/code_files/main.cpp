...
int main() {    
    ...
    printf("=== Experiment 01: Scaling with Particle Count (Approach 2: Immediate) ===\n");
    ...
    for (int g = 0; g < num_grid_configs; g++) {
        ...
        for (int pc = 0; pc < num_point_configs; pc++) {
            ...
            for (int iter = 0; iter < Maxiter; iter++) {  
                ...
                // Using Approach 2: Immediate deletion
                mover_serial_immediate(points, dx, dy, &deleted_count);    
