...
df = pd.read_csv(
    "results/avg_algo_times_Energy_Kernel.csv",
...
plt.title("Compute Throughput vs Problem Size ( For Energy Kernel Operation)")
plt.grid(True, which="both")
plt.tight_layout()
plt.savefig("results/throughput_vs_problem_size_ENERGY_KERNEL.png")
plt.close()
...
plt.title("Memory Bandwidth vs Problem Size ( For Energy Kernel Operation )")
plt.grid(True, which="both")
plt.tight_layout()
plt.savefig("results/bandwidth_vs_problem_size_ENERGY_KERNEL.png")
plt.close()

print("Plots saved successfully:")
print(" - throughput_vs_problem_size_ENERGY_KERNEL.png")
print(" - bandwidth_vs_problem_size_ENERGY_KERNEL.png")
