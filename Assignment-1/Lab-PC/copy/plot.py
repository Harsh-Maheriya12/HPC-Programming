...
df = pd.read_csv(
    "results/avg_algo_times_COPY.csv",
...
plt.title("Compute Throughput vs Problem Size ( For COPY Operation)")
plt.grid(True, which="both")
plt.tight_layout()
plt.savefig("results/throughput_vs_problem_size_COPY.png")
plt.close()
...
plt.title("Memory Bandwidth vs Problem Size ( For COPY Operation )")
plt.grid(True, which="both")
plt.tight_layout()
plt.savefig("results/bandwidth_vs_problem_size_COPY.png")
plt.close()

print("Plots saved successfully:")
print(" - throughput_vs_problem_size_COPY.png")
print(" - bandwidth_vs_problem_size_COPY.png")
