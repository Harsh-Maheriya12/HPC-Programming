...
plt.title("Compute Throughput vs Problem Size ( For ADD Operation)")
plt.grid(True, which="both")
plt.tight_layout()
plt.savefig("results/throughput_vs_problem_size_ADD.png")
plt.close()
...
plt.title("Memory Bandwidth vs Problem Size ( For ADD Operation )")
plt.grid(True, which="both")
plt.tight_layout()
plt.savefig("results/bandwidth_vs_problem_size_ADD.png")
plt.close()

print("Plots saved successfully:")
print(" - throughput_vs_problem_size_ADD.png")
print(" - bandwidth_vs_problem_size_ADD.png")
